...
class listadoPrincipal extends StatefulWidget {
  @override
  _listadoPrincipalState createState() => _listadoPrincipalState();
}

class _listadoPrincipalState extends State<listadoPrincipal> {
  late List dataApi = [];
  
  Future<String> getData() async {
    var response = await http.get(Uri.parse(api[0]["gameList"]!));
    setState(() {
